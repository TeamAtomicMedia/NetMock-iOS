...
struct Tests {
    ...
    @Test func overridesApplyToUnsequencedAPI() async throws {
        await NetMock.shared.override(.GET, NetworkAPI.exampleAPI, response: .code(500))
    ...
    @Test func overridesApplyToSequencedAPI() async throws {
        await NetMock.shared.override(.GET, NetworkAPI.sequencedAPI, response: .code(500))
    ...
    @Test func overridesCanMakeAPISucceed() async throws {
        await NetMock.shared.override(.GET, NetworkAPI.exampleFailureAPI, response: .code(200))
    ...
    @Test func overridesCanMakeNoInternet() async throws {
        await NetMock.shared.override(.GET, NetworkAPI.exampleFailureAPI, response: .code(-1009))
